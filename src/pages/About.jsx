  ...
  return (
    <>
      <div className="d-flex main_house_con">
        <MenuSideBar makeShort={true} activeLink={"about"} />
          ...
          <div className="housing d-flex gap-1 position-relative">
            <div id="scrollable-section" className="col main_section">
              <div className="d-flex align-items-center gap-2 mb-3">
                ...
                <Link>
                  <p className="crumb_link">/ About Us</p>
                </Link>
              </div>
              <div
                className="vb_con"
                style={{
                  backgroundImage:
                    "url(./assets/images/vb_bg2.png), url(), url(./assets/images/about_bg.png)",
                }}>
                <div className="vb_banner_con"></div>
                <div className="col vb_banner_cont text-center">
                  <div className="col">
                    <div className="col mb-5">
                      <p className="vb_head">Game On</p>
                      <p className="vb_title mb-3">About</p>
                    ...
                    <div className="col d-flex flex-wrap gap-4 mb-5">
                      <div
                        ...
                        <img
                          src={"./assets/images/icons/icon_flag.svg"}
                          alt=""
                          className="step_img mb-3"
                        />
                        <p className="vb_contact_text">
                          We are based in Sweden, and also ship to over 200
                          countries worldwide.
                        </p>
                      </div>
                      <div
                        ...
                        />
                        <p className="vb_contact_text">
                          They have an average rating of 4.7 stars on
                          Trustpilot, based on over 100 reviews.
                        </p>
                      </div>
                    </div>
                    ...
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "url(./assets/images/red_bg.png), url(./assets/images/blue_bg.png), url(./assets/images/step_bg.png)",
                      }}>
                      <div className="vb_step_col pt-0">
                        <div className="d-flex justify-content-center mb-3">
                          <div className="vb_plan_tag red text-center pb-2">
                            <p className="">5</p>
                          </div>
                        </div>
                        <p className="vb_title mb-5">Reasons to work with Us</p>

                        <div className="col d-flex flex-wrap justify-content-center gap-5">
                          <div className="col-12 col-md-3 col-xl text-center">
                            <img
                              src={"./assets/images/icons/icon_good.svg"}
                              alt=""
                              className="step_img mb-3"
                            />
                            <p className="vb_contact_text">
                              Wide selection of games with competitive prices
                            </p>
                          </div>
                          <div className="col-12 col-md-3 col-xl text-center">
                            <img
                          ...
                          <div className="col-12 col-md-3 col-xl text-center">
                            ...
                            />
                            <p className="vb_contact_text">
                              Easy-to-use website with secure payment processing
                            </p>
                          </div>
                          <div className="col-12 col-md-3 col-xl text-center">
                            <img
