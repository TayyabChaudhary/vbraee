...
export default function Category({ activeCategory }) {
  ...
  const backgroundImage = (value) => {
    switch (value) {
      case "psn":
        return "url('./assets/images/psn_bg.png')";
      case "xbox":
        return "url('./assets/images/xbox_bg.png')";
      case "nintendo":
        return "url('./assets/images/nintendo_bg.png')";
      case "gift-cards":
        return "url('./assets/images/gift_card_bg.png')";
      case "pc-gaming":
        return "url('./assets/images/pc_gaming_bg.png')";
      case "skins":
        return "url('./assets/images/skins_bg.png')";
      case "software":
        return "url('./assets/images/software_bg.png')";
      case "vr-games":
        return "url('./assets/images/vr_game_bg.png')";
      case "weekly-deals":
        return "url('./assets/images/weekly_deal_bg.png')";
      default:
        return "url('./assets/images/psn_bg.png')";
    }
  };
    ...
    <>
      <div className="d-flex main_house_con">
        ...
        <div
          ...
          style={{
            backgroundImage: backgroundImage(activeCategory),
          }}>
          ...
          <div className="housing d-flex gap-1 position-relative">
            <div id="scrollable-section" className="col main_section">
              <div className="d-flex align-items-center gap-2 mb-3">
                ...
                <Link>
                  <p className="crumb_link">/ PSN</p>
                </Link>
              </div>

              <div className="main_cont d-flex gap-4 position-relative">
                <CategoryFilter isOpen={isFilterOpen} onClose={CloseFilter} />
                <div className="w-100">
                  <p className="cate_filter_head mb-2">34 ITEMS</p>

                  <h3 className="cate_header mb-2">PlayStation Network</h3>
                  <p className="cate_desc d-none d-xl-block mb-4">
                    A PlayStation Store gift card is the best way to buy games
                    from the PlayStation store without a credit card. You can
                    either use it yourself or give it to someone known for
                    spending much time with one of Sony’s consoles. The content
                    available on the PlayStation Network is well worth the
                    investment. Especially given the fact that Kinguin is the
                    best place for cheap PlayStation gift cards!
                  </p>
