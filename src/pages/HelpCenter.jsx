                  ...
                  <div className="col">
                    <div className="col mb-5">
                      <p className="vb_title mb-4">
                        Welcome to The Vbrae support
                      </p>

                      <div className="col col-md-8 vb_search d-flex gap-3 align-items-center mx-auto">
                        <input
                          type="text"
                          className="vb_search_input"
                          placeholder="Start typing your question here..."
                        />
                        <button type="button" className="vb_search_icon">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="1em"
                            height="1em"
                    ...
                    <div className="col row row-cols-1 row-cols-md-3 mb-5">
                      <Link to={"/help-topic"} className="col p-2">
                        <div
                          ...
                          <img
                            ...
                            className="mb-3"
                          />
                          <p className="vb_tit mb-2">Account</p>
                        </div>
                      </Link>
                      <Link to={"/help-topic"} className="col p-2">
                        <div
                          ...
                          <img
                            src={"./assets/images/icons/icon_vendor.svg"}
                            alt=""
                            height={"30px"}
                            className="mb-3"
                          />
                          <p className="vb_tit mb-2">Vendors</p>
                        </div>
                      </Link>
                      <Link to={"/help-topic"} className="col p-2">
                        <div
                          ...
                          <img
                            src={"./assets/images/icons/icon_order.svg"}
                            alt=""
                            height={"30px"}
                            className="mb-3"
                          />
                          <p className="vb_tit mb-2">Order & Returns</p>
                        </div>
                      </Link>
                      <Link to={"/help-topic"} className="col p-2">
                        <div
                          ...
                          <img
                            ...
                            className="mb-3"
                          />
                          <p className="vb_tit mb-2">Shipping & Delivery</p>
                        </div>
                      </Link>
                      <Link to={"/help-topic"} className="col p-2">
                        <div
                          ...
                          <img
                            ...
                            className="mb-3"
                          />
                          <p className="vb_tit mb-2">Earning & Payouts</p>
                        </div>
                      </Link>
                      <Link to={"/help-topic"} className="col p-2">
                        <div
                          ...
                          <img
                            ...
                            className="mb-3"
                          />
                          <p className="vb_tit mb-2">Payment</p>
                        </div>
                      </Link>
                    </div>

                    <div className="col mb-4">
                      <p className="vb_title mb-1">
                        Articles above haven&apos;t addressed your concerns?
                      </p>
