...
function OrderFilter({ isOpen, onClose }) {
  return (
    <>
      <div
        className={
        ...
        <div className="col-auto row g-3 g-lg-2 mb-4 mb-lg-0">
          ...
          <div className="col-12 col-lg-6 col-xl">
            <div className="col-12 acct_box ">
              <input type="text" className="input_box" placeholder="Id" />
            </div>
          </div>
          <div className="col-12 col-lg-6 col-xl d-flex gap-2">
        ...
        <div className="col housing_con d-flex flex-column">
          ...
          <div id="scrollable-section" className="col acct_cont_con pt-lg-0">
            ...
            <div className="acct_cont ">
              <div className="col">
                <OrderFilter isOpen={isFilterOpen} onClose={CloseFilter} />
                ...
                <div className="col d-lg-none mb-4">
                  <div className="mob_table_con position-relative mb-3">
                    <div className="col row gx-4 gy-3">
                      ...
                      <div className="col-6">
                        ...
                        <p className="mob_table_data">$26.02</p>
                      </div>
                      <div className="col-6">
                  ...
                  <div className="mob_table_con position-relative mb-3">
                    <div className="col row gx-4 gy-3">
                      ...
                      <div className="col-6">
                        <label className="mob_table_head">Payment</label>
                        <p className="mob_table_data bold">Canceled</p>
                      </div>
                  ...
                  <table className="table table-borderless acct_table mb-3">
                    <thead>
                      <tr>
                        ...
                        <th className="acct_table_head">Total</th>
                    ...
                    <tbody>
                      <tr className="acct_table_row">
                        ...
                        <td className="acct_table_data">$26.02</td>
                        <td className="acct_table_data col-4">Cancelled</td>
                        <td className="acct_table_data">
                          <span className="acct_table_data_tag green">
                            Delivered
                          </span>
                      ...
                      <tr className="acct_table_row active">
                        ...
                        <td className="acct_table_data">$26.02</td>
                        <td className="acct_table_data">Cancelled</td>
                        <td className="acct_table_data">
                          <span className="acct_table_data_tag red">
                            Cancelled
                          </span>
