  ...
  return (
    <>
      <div className="d-flex main_house_con">
        <MenuSideBar makeShort={true} activeLink={"redeem"} />
          ...
          <div className="housing d-flex gap-1 position-relative">
            <div id="scrollable-section" className="col main_section">
              <div className="d-flex align-items-center gap-2 mb-3">
                ...
                <Link>
                  <p className="crumb_link">
                    / Redeem Argentina and Turkey Games
                  </p>
                </Link>
              </div>

              <div
                className="main_cont bg_img"
                style={{
                  backgroundImage: "url(./assets/images/vb_bg2.png)",
                }}>
                <p className="vb_title mb-4">
                  Redeem Argentina and Turkey Games
                </p>
                <div className="vb_acct_cont mb-4">
                  <div className="vb_text">
                    <p className="mb-2">
                      You have come to this page because you whant to know how
                      to redeem your bought key thats from another region?{" "}
                      <br /> Dont worry this guide will help you all. <br /> We
                      have guides for Argentina and Turkey. <br /> Enjoy
                    </p>

                    <p className="vb_title_sm dark mb-2">
                      How to redeem the key using phone for Argentina Keys?
                    </p>

                    <p className="mb-2">
                      1- open the browser and go to the xbox site or type "
                      xbox.com " and open your account. <br /> 2- go to the
                      redeem page or just copy this
                      "https://redeem.microsoft.com". <br /> 3- switch and go to
                      the app store on your phone and search for an app called "
                      VPN.lat ". <br /> 4- download the APP then open the APP.{" "}
                      <br /> 5- chose the argentina country inside the app then
                      click on connect. <br /> 6- once your connected switch to
                      the internet browser. <br /> 7- refresh the redeem page
                      and write the key on the redeem page and click redeem and
                      your done. <br /> 8- go back to your xbox to download and
                      play the game.
                    </p>

                    <p className="vb_title_sm dark mb-2">
                      Redeem on your phone : Turkey Key
                    </p>
                    ...
                    <p className="vb_title_sm dark mb-2">
                      How to redeem the key using phone for Egyptian Keys?
                    </p>
                ...
                <div className="col mb-5">
                  <p className="vb_title_sm text-center mb-4">
                ...
                <div className="col text-center">
                  ...
                  <div className="d-flex justify-content-center gap-3">
                    <Link to={"/psn"}>
                      <button
                        type="button"
                        className="col col-md-auto vb_contact_btn2 d-flex justify-content-center align-items-center">
                        Go back to catelog
                      </button>
                    </Link>
                    <Link to={"/submit-request"}>
                      <button
                        type="button"
                        className="col col-md-auto details_button d-flex justify-content-center align-items-center">
                        <svg
                          className="me-2"
                          width="20"
                          height="20"
              ...
              <div className="col d-lg-none mt-3">
                <MainFooter />
              </div>
            </div>
