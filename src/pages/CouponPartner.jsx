...
export default function CouponPartner() {
  return (
    <>
      <div className="d-flex main_house_con">
        <MenuSideBar makeShort={true} activeLink={"coupon-partner"} />
        ...
        <div
          ...
          <MainHeader activeLink={"coupon-partner"} />
          ...
          <div className="housing d-flex gap-1 position-relative">
            <div id="scrollable-section" className="col main_section">
              <div className="d-flex align-items-center gap-2 mb-3">
                ...
                <Link>
                  <p className="crumb_link">/ Coupon Partners</p>
                </Link>
              </div>
              <div
                className="vb_con"
                style={{
                  backgroundImage:
                    "url(./assets/images/vb_bg2.png), url(), url(./assets/images/coupon_bg.png)",
                }}>
                <div className="vb_banner_con"></div>
                <div className="col vb_banner_cont text-center">
                  <div className="col">
                    <div className="col mb-5">
                      <p className="vb_head">our the best</p>
                      <p className="vb_title mb-4">Coupon Partners</p>
                      <p className="vb_text">
                    ...
                    <div className="col d-flex flex-wrap gap-4 justify-content-center mb-5">
                      <div
                        className="col-12 col-md-5 col-xl vb_off_cont images d-flex justify-content-center align-items-center"
                        style={{
                          backgroundImage:
                            "url(./assets/images/red_bg.png), url(./assets/images/blue_bg.png)",
                        }}>
                        <img
                          src={"./assets/images/coupon1.png"}
                          alt=""
                          className="vb_off_img"
                        />
                      </div>
                      <div
                        className="col-12 col-md-5 col-xl vb_off_cont images d-flex justify-content-center align-items-center"
